...
The [Ok Ducky!](https://okducky.gamolf.fr) video game is a funfair duck shooter. It was created from [a graphics assets pack](https://kenney.nl/assets/shooting-gallery) by [Kenney](https://kenney.nl) during a charity stream on [Twitch](https://www.twitch.tv/patrickpremartin) for [Sidaction 2021](https://www.sidaction.org).

The game works with a mouse or finger/stylus, depending on your equipment.

It was developed in [Delphi](https://developpeur-pascal.fr/delphi.html). This code repository contains the source code and some of the graphics. Some files could not be distributed for copyright and licence reasons.

This code repository contains a project developed in Object Pascal language under Delphi. You don't know what Delphi is and where to download it ? You'll learn more [on this web site](https://delphi-resources.developpeur-pascal.fr/).

## Using this video game

Visit [the Ok Ducky! website](https://okducky.gamolf.fr) to download the compiled version, learn more about how it works, access videos and articles, find out about the different versions available and their features, contact user support...
...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its GitHub repository](https://github.com/DeveloppeurPascal/Ok-Ducky).
...
Documentation is exported in HTML by [DocInsight](https://devjetsoftware.com/products/documentation-insight/) or [PasDoc](https://pasdoc.github.io) to the /docs folder of the repository. You can also [access it online](https://developpeurpascal.github.io/Ok-Ducky) through the hosting offered by GitHub Pages.

Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://okducky.gamolf.fr) or [the project devlog](https://developpeur-pascal.fr/ok-ducky.html).
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://github.com/DeveloppeurPascal/Ok-Ducky/issues) so that I can test and try to correct or provide a workaround.
...
If this license doesn't suit your needs (especially for a commercial project) I also offer [classic licenses for developers and companies](https://okducky.gamolf.fr).
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://github.com/DeveloppeurPascal/Ok-Ducky) and [open a new issue](https://github.com/DeveloppeurPascal/Ok-Ducky/issues).
