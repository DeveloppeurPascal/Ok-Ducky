...
const
  CTxtEN = '''
Ok Ducky! was developed during live coding sessions on Twitch with FireMonkey under Delphi.
...
Graphics (sprites and user interface) from Kenney and Adobe Stock.
...
To find out more, visit https://okducky.gamolf.fr

''';
   CTxtFR = '''
Ok Ducky! a été développé lors de sessions de codage en direct sur Twitch avec FireMonkey sous Delphi.
...
Les graphismes (sprites et interface utilisateur) proviennent de Kenney et Adobe Stock.
...
Pour en savoir plus, visitez https://okducky.gamolf.fr
