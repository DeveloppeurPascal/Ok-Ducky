...
const
  ...
  /// </summary>
  CAboutGameURL = 'https://okducky.gamolf.fr/';
...
{$ENDIF}
  ...
  /// (without deployment)
  /// </summary>
  CDefaultBackgroundMusicPath = '..\..\..\_PRIVATE\GinnyCulp\';
  ...
  /// </remarks>
  CBackgroundMusicFileName = 'WesternTwilight60.mp3';
  ...
  /// (without deployment)
  /// </summary>
  CDefaultSoundEffectsPath = '..\..\..\_PRIVATE\TheGameCreators\SoundMatter\';
  ...
  /// </summary>
  CGameGUID = '{E063007E-F094-4499-AD2A-A52B024D761D}';
